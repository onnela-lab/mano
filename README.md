...
- Some features of Mano require a more recent version of the Beiwe Backend software than your server
  is running. Please let your Beiwe System Administrator know if you run into any issues. The Beiwe
  Platform provides extensive documentation for system administrators to handle any issues they may
  encounter in the upgrade process.


## Table of contents
1. [Requirements](#requirements-and-compatibility)
